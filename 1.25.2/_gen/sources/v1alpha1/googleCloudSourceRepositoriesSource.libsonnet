{
  ...
  spec: {
    ...
    '#serviceAccountKey':: d.obj(help='"Deprecated - please use spec.auth.serviceAccountKey. Service account key used to authenticate the event source and allow it to interact with Google Cloud APIs. Only the JSON format is supported."'),
    serviceAccountKey: {
      '#valueFromSecret':: d.obj(help='"A reference to a Kubernetes Secret object containing the service account key."'),
      valueFromSecret: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { serviceAccountKey+: { valueFromSecret+: { key: key } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { serviceAccountKey+: { valueFromSecret+: { name: name } } } },
      },
      '#withValue':: d.fn(help='"Literal value of the service account key."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { serviceAccountKey+: { value: value } } },
    },
