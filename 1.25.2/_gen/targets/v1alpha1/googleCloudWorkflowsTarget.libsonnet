{
  ...
  spec: {
    ...
    '#credentialsJson':: d.obj(help='"GCP credentials used to programmatically interact with Google Cloud Storage. For additional information, refer to https://cloud.google.com/docs/authentication/production."'),
    credentialsJson: {
