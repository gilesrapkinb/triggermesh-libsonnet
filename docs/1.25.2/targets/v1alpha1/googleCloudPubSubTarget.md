---
permalink: /1.25.2/targets/v1alpha1/googleCloudPubSubTarget/
---
...
"GCP credentials used to programmatically interact with Google Cloud Pub/Sub. For additional information, refer to https://cloud.google.com/docs/authentication/production."
